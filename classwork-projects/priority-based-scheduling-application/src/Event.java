...
/**
 * This class models an Event for the CS300 P10 project Priority Events. These objects are
 * comparable to other Event objects, for inclusion in a priority queue.
 */
public class Event implements Comparable<Event> {
  ...
  /**
   * Change the Event class month to the given month. This will NOT modify the date/time associated
   * with any previously-constructed Events, which store ALL date/time information in an instance
   * variable.
   * 
