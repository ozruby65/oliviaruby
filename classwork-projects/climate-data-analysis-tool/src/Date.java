...
public class Date {
  ...
  /**
   * Compares two dates in the same winter. Dates in August and later are assumed to be from the
   * previous year, e.g. March is later than August but earlier than July.
   * 
