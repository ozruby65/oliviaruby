...
public class LakeRecord {
  ...
  /**
   * Gets an integer representation of the winter Ex. "1959-60" -> 1959
   *
  ...
  public void mergeWith(LakeRecord other) {
    ...
    if (other.getThawDate() != null
        && (this.thawDate == null || Date.compareDates(other.getThawDate(), this.thawDate) > 0)) {
  ...
  /**
   * Returns true if the two LakeRecords are equal, defined as having equal the same winter, freeze
   * date, thaw date, and total days of ice cover.
   *
